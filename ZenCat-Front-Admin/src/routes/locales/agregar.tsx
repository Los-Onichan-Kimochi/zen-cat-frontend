            ...
            <div className="grid grid-cols-1 gap-y-6">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Ingrese de la calle o avenida"
                />
                {errors.street_name && (
                  <p className="text-red-500 text-sm mt-1">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Ingrese el numero del edificio"
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      value={
                        regions.find((r) => r.name === field.value)?.id ?? ''
                      }
                    >
                      <SelectTrigger>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      value={
                        filteredProvinces.find((p) => p.name === field.value)
                          ?.id ?? ''
                      }
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <Select
                      ...
                      value={
                        filteredDistricts.find((d) => d.name === field.value)
                          ?.id ?? ''
                      }
            ...
            <div className="flex flex-col space-y-40">
              ...
              <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-2 sm:justify-end pt-4">
                <Button
                  ...
                  className="w-full sm:w-auto h-12 text-lg px-6"
                >
                  Cancelar
                </Button>
                <Button
