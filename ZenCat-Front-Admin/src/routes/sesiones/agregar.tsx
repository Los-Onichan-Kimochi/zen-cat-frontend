...
function AddSessionComponent() {
  ...
  const onSubmit = (data: SessionFormData) => {
    ...
    const payload: CreateSessionPayload = {
      title: data.title,
      date: `${format(data.date, 'yyyy-MM-dd')}T00:00:00Z`,
      start_time: `${format(data.date, 'yyyy-MM-dd')}T${data.start_time}:00Z`,
      end_time: `${format(data.date, 'yyyy-MM-dd')}T${data.end_time}:00Z`,
              ...
              <CardContent>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <DatePicker
                          ...
                          onDateChange={(date) => {
                            setValue('date', date);
                            // Actualizar el mes cuando se selecciona una fecha
                            if (date) {
                    ...
                    {/* Campos de hora con selector interactivo */}
                    <div className="space-y-4">
