...
const professionalFormSchema = z.object({
  ...
  phone_number: z
    .string()
    .min(7, { message: 'El número de celular debe tener al menos 7 dígitos.' }),
...
function AddProfessionalPageComponent() {
  ...
  const createProfessionalMutation = useMutation({
    mutationFn: async (data: CreateProfessionalPayload) =>
      professionalsApi.createProfessional(data),
    onSuccess: () => {
    ...
    <div className="p-2 md:p-6 h-full flex flex-col font-montserrat">
      ...
      <Card className="mt-6 flex-grow">
        <CardHeader>
          ...
          <CardDescription>
            Complete la información para agregar un nuevo profesional.
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid grid-cols-1 gap-y-6">
              <div>
                ...
                <Input
                  id="name"
                  {...register('name')}
                  placeholder="Ingrese los nombres del profesional"
                />
                {errors.name && (
              ...
              <div>
                <Label htmlFor="first_last_name" className="mb-2">
                  Primer apellido
                </Label>
                <Input
                  id="first_last_name"
              ...
              <div>
                <Label htmlFor="second_last_name" className="mb-2">
