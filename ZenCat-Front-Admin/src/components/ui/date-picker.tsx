    ...
    <Popover>
      ...
      <PopoverContent className="w-auto p-0">
        <Calendar
          ...
          modifiersClassNames={{
            occupied: "bg-red-100 text-red-700 hover:bg-red-200 hover:text-red-800 font-medium relative after:content-[''] after:absolute after:bottom-1 after:left-1/2 after:transform after:-translate-x-1/2 after:w-1 after:h-1 after:bg-red-500 after:rounded-full",
          }}
        />
      </PopoverContent>
    </Popover>
