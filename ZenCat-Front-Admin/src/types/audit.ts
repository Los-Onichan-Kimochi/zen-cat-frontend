...
export const getActionConfig = (action: AuditAction, isError: boolean = false): ActionBadgeConfig => {
...
export const getEntityConfig = (entityType: AuditEntityType, isError: boolean = false): EntityBadgeConfig => {
