        ...
        <section id="contacto" className="scroll-mt-24 bg-gray-50 py-8">
            <div className="container mx-auto px-4">
                ...
                <p className="text-center text-gray-600 mb-6">
                    ¿Tienes dudas sobre grupos, horarios o membresías? Llena el formulario y te responderemos pronto.
                </p>
                        ...
                        <div className="bg-white shadow-lg rounded-lg p-6">
                            {estadoEnvio === 'exito' ? (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="mt-2 text-gray-600">Nos pondremos en contacto contigo pronto.</p>
                                </div>
                            ) : (
                                // Formulario activo
                        ...
                        <div className="bg-white shadow-lg rounded-lg p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 mt-1 flex items-center">
                                    ...
                                    <a href="mailto:informes@astrocats.com" className="text-blue-800 hover:underline">
                                ...
                                <div className="space-y-4 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">
                                            <strong>Horario:</strong> Lun–Vie: 8:00 AM – 8:00 PM | Sáb–Dom: 9:00 AM – 2:00 PM
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">
                                            <strong>Horario:</strong> Lun–Vie: 7:00 AM – 7:00 PM | Sáb: 8:00 AM – 1:00 PM
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">
                                            <strong>Horario:</strong> Lun–Vie: 9:00 AM – 9:00 PM | Dom: 10:00 AM – 2:00 PM
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <p className="text-sm text-gray-500 text-center mt-8">
                    ...
                    <a href="/politica-privacidad" className="text-blue-800 hover:underline">
